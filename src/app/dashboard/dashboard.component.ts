...
export class DashboardComponent implements OnInit {
  ...
  factory() {
   ...
   this.renderer.addClass(path1,'resize-drag');
    ...
    //this.renderer.addClass(path3,'resize-drag');
    ...
    //this.renderer.addClass(path4,'resize-drag');
    ...
    //this.renderer.addClass(path5,'resize-drag');
    ...
    //this.renderer.addClass(path6,'resize-drag');
    ...
    //this.renderer.addClass(path7,'resize-drag');
    ...
    //this.renderer.addClass(path8,'resize-drag');
    ...
    //this.renderer.addClass(path9,'resize-drag');
    ...
    //this.renderer.addClass(path10,'resize-drag');
    ...
    //this.renderer.addClass(path11,'resize-drag');
    ...
    //this.renderer.addClass(path12,'resize-drag');
    ...
    //this.renderer.addClass(path13,'resize-drag');
    ...
    //this.renderer.addClass(path14,'resize-drag');
    ...
    //this.renderer.addClass(path15,'resize-drag');
    ...
    //this.renderer.addClass(path16,'resize-drag');
    ...
    //this.renderer.addClass(path17,'resize-drag');
    ...
    //this.renderer.addClass(path18,'resize-drag');
    ...
    //this.renderer.addClass(path19,'resize-drag');
    ...
    //this.renderer.addClass(path20,'resize-drag');
    ...
    //this.renderer.addClass(path21,'resize-drag');
    ...
    //this.renderer.addClass(path22,'resize-drag');
    ...
    //this.renderer.addClass(path23,'resize-drag');
    ...
    //this.renderer.addClass(path24,'resize-drag');
    ...
    //this.renderer.addClass(path25,'resize-drag');
    ...
    //this.renderer.addClass(path26,'resize-drag');
    ...
    //this.renderer.addClass(path27,'resize-drag');
    ...
    //this.renderer.addClass(path28,'resize-drag');
    ...
    //this.renderer.addClass(path29,'resize-drag');

    this.renderer.addClass(svg,'resize-drag');
  ...
  circle() {
    let svg = this.renderer.createElement('svg', 'svg');
    this.renderer.setAttribute(svg, 'id', this.svgId);
    this.renderer.setAttribute(svg, 'width', '1.4423in');
    this.renderer.setAttribute(svg, 'height', '1.4423in');
    this.svgId++;
    ...
    this.renderer.setAttribute(circle, 'name', 'circle');
    ...
    this.renderer.addClass(circle,'resize-drag');
    this.renderer.setAttribute.arguments(circle, 'style', 'color: red; width: 120px; height: 12px auto')
   //console.log(svg.getElementById('circle'));
  ...
  rectangle() {
    ...
    let svg = this.renderer.createElement('svg', 'svg');
    this.renderer.setAttribute(svg, 'name', 'rectangle');
    this.renderer.setAttribute(svg, 'id', this.svgId);
    ...
    //let g = this.renderer.createElement('div');
   ...
   // this.renderer.setAttribute(rectangle, "{{test}}");
  ...
  displayProperties(properties: any) {
    ...
    for (let i = 0; i < (properties.length); i += 2) {
      ...
      this.renderer.listen(input, 'change', (event) => {
        alert(properties[i] + " is "+ input.value + " " + properties[1]);
       
        if (properties[1] === 'rectangle'){
          alert('rectangle called ')
         // this.renderer.setAttribute(this.rectangle, 'style', 'fill:rgb(0,0,255);stroke-width:3;stroke:rgb(0,0,0)');
         let a =  document.getElementById('0').childNodes;
         console.log( a[0])
         //a[0].setAttribute()
        // a[0].setAttributeNode('style', 'fill:rgb(0,0,0);stroke-width:3;stroke:rgb(0,0,0)')
        a[0].setAttribute('style', 'fill:rgb(0,0,0);stroke-width:3;stroke:rgb(0,0,0)')
        //a.forEach
      //   for(var child=a.firstChild; child!==null; child=child.nextSibling) {
      //     console.log(child);
      // }
      ...
      // td1.setAttribute("ng-model", "test");
      // let tdText1 = this.renderer.createText(properties[i + 1]);
